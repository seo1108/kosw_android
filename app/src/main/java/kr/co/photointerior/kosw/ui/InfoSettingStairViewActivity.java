 ...
 * 계단 전환
 */
public class InfoSettingStairViewActivity extends BaseUserActivity implements ItemClickListener{
    private String TAG = LogUtils.makeLogTag(InfoSettingStairViewActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_info_setting_stair_view);
    ...
    protected void setInitialData() {
        for( Building b : mList ){
            b.setSelected( b.isDefaultBuilding() );
        }
